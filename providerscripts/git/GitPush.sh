...
# Author: Peter Winter
# Date  : 04/07/2016
# Description : This is a script which pushes to a remote repository
######################################################################################
# License Agreement:
...
INFRASTRUCTURE_REPOSITORY_PASSWORD="`${HOME}/utilities/config/ExtractConfigValue.sh 'INFRASTRUCTUREREPOSITORYPASSWORD'`"
