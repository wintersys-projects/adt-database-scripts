...
${HOME}/providerscripts/utilities/remote/ConnectToPostgresDB.sh "dbaas-init" "notraw" "" < ${HOME}/runtime/postgres-init/initialiseDB-user.psql
${HOME}/providerscripts/utilities/remote/ConnectToPostgresDB.sh "dbaas-init" "notraw" "" < ${HOME}/runtime/postgres-init/initialiseDB.psql
