...
/bin/echo '@hourly export HOME="'${HOME}'" && '${HOME}'/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config" "dbbackuplock.file" "local"' >> /var/spool/cron/crontabs/root
