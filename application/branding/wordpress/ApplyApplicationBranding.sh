...
then
	...
	/bin/sed -i "s/The GreatApplication/${WEBSITE_NAME}/g" ${HOME}/backups/installDB/${WEBSITE_NAME}DB.sql
	/bin/sed -i "s/GreatApplication/${WEBSITE_NAME}/g" ${HOME}/backups/installDB/${WEBSITE_NAME}DB.sql
	/bin/sed -i "s/GREATAPPLICATION/${WEBSITE_NAME_UPPER}/g" ${HOME}/backups/installDB/${WEBSITE_NAME}DB.sql
	/bin/sed -i "s/THE GREATAPPLICATION/${WEBSITE_NAME_UPPER}/g" ${HOME}/backups/installDB/${WEBSITE_NAME}DB.sql
	FROM_EMAIL="`${HOME}/utilities/config/ExtractConfigValue.sh 'EMAILUSERNAME'`"
